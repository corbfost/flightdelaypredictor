...
def initialize():
    ...
    pos_model = sm.regression.linear_model.RegressionResults.load('gammlog_pos.pickle')
    neg_model = sm.regression.linear_model.RegressionResults.load('gammlog_neg.pickle')
